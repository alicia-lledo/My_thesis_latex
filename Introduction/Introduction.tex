...
-Coding variants are an small proportion: e.g in psoriasis and PsA from exome wide studies
-Potential role of those variants regulating gene expression
-Strategies and resources to incorporate in order to better understand these variants
