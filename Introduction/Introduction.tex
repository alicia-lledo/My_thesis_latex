...
GWAS studies have revealed a large number of SNPs associated to different complex diseases. From all the GWAS associations, approximately 88\% of the hits map within non-coding regions and only few are coding variants causing non-synonymous mutations with impact in proteins by truncation or alteration in folding or glycosylation \parencite{Welter2013}. 
...
In psoriasis and PsA some SNPs located at 3' UTR of genes such as \textit{IL-23}, \textit{TRAF3IP2} or \textit{SOCS1} have been hypothesised to create or alter miRNA binding sites but there is lack of experimental evidence \parencite{Pivarcsi2014}.

-Splicing alterations

-eQTL relevance in this context to introduce the models


-Availability of resources to help in this and post-GWAS approaches.
...
%Examples of CNV (mention psoriasis LCE and CARD14 and also big studey about CNV) and also explanation of translocations in the heritability
