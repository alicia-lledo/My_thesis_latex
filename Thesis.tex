...
\usepackage[backend=bibtex, style=authoryear, maxcitenames=2, mincitenames=1, minbibnames=5, maxbibnames=5, dashed=false, doi=false, url=false, isbn=false]{biblatex} 
