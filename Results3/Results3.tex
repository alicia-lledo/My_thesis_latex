...
-Check SLE pathways
-Overall interesting functionally meaningful differences, limitation of sample size and also the way of defining master list and linking DARs to genes by proximity, which is not taking into account long range interactions. Also DARs with opposite direction of change can be nearby or within same gene.
